...
export function ApplicationTable({ applications, onSelectApplication, onDeleteApplication }: ApplicationTableProps) {
  ...
  return (
    <div className="space-y-6" id="applications-table-section">
      ...
      <div className="glass-panel p-5 rounded-2xl border border-slate-800 shadow-sm space-y-4">
      ...
      {/* Table grid wrapper */}
      <div className="glass-panel rounded-[2rem] border border-slate-800 shadow-2xl overflow-hidden">
